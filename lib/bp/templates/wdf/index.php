...
<?php get_header( 'buddypress' ); ?>
	...
	<div id="content">
		...
		<form action="" method="post" id="wdf-directory-form" class="dir-form">
			...
			<h3><?php _e( 'High Fives-Verzeichnis', 'wdf' ); ?></h3>
			...
			<div class="item-list-tabs no-ajax" role="navigation">
				<ul>
					<li class="selected" id="groups-all"><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_wdf_root_slug() ); ?>"><?php printf( __( 'Alle High Fives <span>%s</span>', 'buddypress' ), bp_wdf_get_total_donation_count() ); ?></a></li>
