 ...
 */
 ...
 add_filter( 'bp_wdf_get_item_name', 'wp_filter_kses', 1 );
 ...
 */
 ...
 add_filter( 'wdf_data_fieldname1_before_save', 'wp_filter_kses', 1 );
 add_filter( 'wdf_data_fieldname2_before_save', 'wp_filter_kses', 1 );
